	...
	<lx-form size="small">
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="2">
				...
				<lx-input-number v-model='cycle02' :min="0" :max="60" /> 秒
			</lx-radio>
		</lx-form-item>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="3">
				从
				<lx-input-number v-model='average01' :min="0" :max="60" /> 秒开始，每
				<lx-input-number v-model='average02' :min="0" :max="60" /> 秒执行一次
			</lx-radio>
		</lx-form-item>
