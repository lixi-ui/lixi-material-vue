	...
	<lx-form size='small'>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="3">
				周期从星期
				<lx-input-number v-model='cycle01' :min="1" :max="7" /> -
				<lx-input-number v-model='cycle02' :min="1" :max="7" />
			</lx-radio>
		</lx-form-item>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="4">
				第
				<lx-input-number v-model='average01' :min="1" :max="4" /> 周的星期
				<lx-input-number v-model='average02' :min="1" :max="7" />
			</lx-radio>
		</lx-form-item>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="5">
				本月最后一个星期
				<lx-input-number v-model='weekday' :min="1" :max="7" />
			</lx-radio>
		</lx-form-item>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="6">
				...
				<lx-select clearable v-model="checkboxList" placeholder="可多选" multiple style="width:100%">
					<lx-option v-for="(item,index) of weekList" :key="index" :value="index+1">{{item}}</lx-option>
				</lx-select>
			</lx-radio>
		</lx-form-item>
