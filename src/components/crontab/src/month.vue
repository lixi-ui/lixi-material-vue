	...
	<lx-form size='small'>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="2">
				周期从
				<lx-input-number v-model='cycle01' :min="1" :max="12" /> -
				<lx-input-number v-model='cycle02' :min="1" :max="12" /> 月
			</lx-radio>
		</lx-form-item>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="3">
				从
				<lx-input-number v-model='average01' :min="1" :max="12" /> 月开始，每
				<lx-input-number v-model='average02' :min="1" :max="12" /> 月月执行一次
			</lx-radio>
		</lx-form-item>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="4">
				...
				<lx-select clearable v-model="checkboxList" placeholder="可多选" multiple style="width:100%">
					<lx-option v-for="item in 12" :key="item" :value="item">{{item}}</lx-option>
				</lx-select>
			</lx-radio>
		</lx-form-item>
	</lx-form>
