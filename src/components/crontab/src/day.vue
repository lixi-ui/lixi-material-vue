	...
	<lx-form size="small">
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="3">
				周期从
				<lx-input-number v-model='cycle01' :min="0" :max="31" /> -
				<lx-input-number v-model='cycle02' :min="0" :max="31" /> 日
			</lx-radio>
		</lx-form-item>
		...
		<lx-form-item>
			<lx-radio v-model='radioValue' :label="4">
				从
				<lx-input-number v-model='average01' :min="0" :max="31" /> 号开始，每
				<lx-input-number v-model='average02' :min="0" :max="31" /> 日执行一次
			</lx-radio>
		</lx-form-item>

		<lx-form-item>
			<lx-radio v-model='radioValue' :label="5">
				每月
				<lx-input-number v-model='workday' :min="0" :max="31" /> 号最近的那个工作日
			</lx-radio>
		</lx-form-item>

		<lx-form-item>
			<lx-radio v-model='radioValue' :label="6">
				本月最后一天
			</lx-radio>
		</lx-form-item>

		<lx-form-item>
			<lx-radio v-model='radioValue' :label="7">
				指定
				<lx-select clearable v-model="checkboxList" placeholder="可多选" multiple style="width:100%">
					<lx-option v-for="item in 31" :key="item" :value="item">{{item}}</lx-option>
				</lx-select>
			</lx-radio>
		</lx-form-item>
	</lx-form>
